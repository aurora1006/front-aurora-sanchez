...
var ThLargeIcon = class _ThLargeIcon extends BaseIcon {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function ThLargeIcon_Factory(t) {
      return (ɵThLargeIcon_BaseFactory || (ɵThLargeIcon_BaseFactory = ɵɵgetInheritedFactory(_ThLargeIcon)))(t || _ThLargeIcon);
    };
  })();
  static ɵcmp = ɵɵdefineComponent({
    type: _ThLargeIcon,
...
var DataView = class _DataView {
  ...
  static ɵfac = function DataView_Factory(t) {
    return new (t || _DataView)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(FilterService), ɵɵdirectiveInject(PrimeNGConfig));
  };
  static ɵcmp = ɵɵdefineComponent({
    type: _DataView,
    ...
    inputs: {
      ...
      trackBy: [InputFlags.HasDecoratorInputTransform, "trackBy", "trackBy", numberAttribute],
      filterBy: "filterBy",
      filterLocale: "filterLocale",
      loading: [InputFlags.HasDecoratorInputTransform, "loading", "loading", booleanAttribute],
      loadingIcon: "loadingIcon",
      first: [InputFlags.HasDecoratorInputTransform, "first", "first", numberAttribute],
      sortField: "sortField",
      sortOrder: [InputFlags.HasDecoratorInputTransform, "sortOrder", "sortOrder", numberAttribute],
      value: "value",
      layout: "layout"
    },
    outputs: {
    ...
    template: function DataView_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵclassMap(ctx.styleClass);
        ɵɵproperty("ngClass", ɵɵpureFunction2(16, _c26, ctx.layout === "list", ctx.layout === "grid"))("ngStyle", ctx.style);
        ɵɵadvance();
        ...
        ɵɵadvance(2);
        ɵɵproperty("ngTemplateOutlet", ctx.itemTemplate)("ngTemplateOutletContext", ɵɵpureFunction1(19, _c35, ctx.paginator ? ɵɵpipeBind3(6, 12, ctx.filteredValue || ctx.value, ctx.lazy ? 0 : ctx.first, (ctx.lazy ? 0 : ctx.first) + ctx.rows) : ctx.filteredValue || ctx.value));
        ɵɵadvance(2);
...
var DataViewLayoutOptions = class _DataViewLayoutOptions {
  ...
  static ɵfac = function DataViewLayoutOptions_Factory(t) {
    return new (t || _DataViewLayoutOptions)(ɵɵdirectiveInject(DataView));
  };
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function DataViewLayoutOptions_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵadvance();
        ɵɵproperty("ngClass", ɵɵpureFunction1(10, _c44, ctx.dv.layout === "list"));
        ɵɵadvance();
        ɵɵproperty("ngIf", !ctx.dv.listIconTemplate);
        ɵɵadvance();
        ɵɵproperty("ngTemplateOutlet", ctx.dv.listIconTemplate);
        ɵɵadvance();
        ɵɵproperty("ngClass", ɵɵpureFunction1(12, _c44, ctx.dv.layout === "grid"));
        ɵɵadvance();
